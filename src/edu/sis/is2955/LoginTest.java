...
public class LoginTest {
	...
	public void testSuccessLogIn() throws Exception {
		...
		//	Input the account number as "dushi792@gmail.com", and correct password as "abc123456"
	...
	public void testFailLogIn() throws Exception {
		...
		//	Input the account number as "dushi792@gmail.com", and wrong password as "abc1"
		driver.findElement(By.id("inputEmailHandle")).sendKeys("dushi792@gmail.com");
